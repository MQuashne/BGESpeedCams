...
cal_obj_px_L2R = 56      # L2R Moving Objects, Length of a calibration object in pixels
cal_obj_mm_L2R = 4665    # L2R Moving Objects, Length of the calibration object in millimetres

cal_obj_px_R2L = 56      # R2L Moving Objects, Length of a calibration object in pixels
cal_obj_mm_R2L = 4665    # R2L Moving Objects, Length of the calibration object in millimetres

# Camera Settings
# ---------------
CAMERA = "usbcam"      # valid values are usbcam, ipcam, pilibcam, pilegcam
CAM_LOCATION = '1733 Parsonage Rd'    # Specify an address, physical location Etc for camera
...
track_counter = 12      # Default= 6 Number of Consecutive Motion Events to trigger speed photo. Adjust to suit.
...
max_speed_over = 10     # Exclude track if Speed less than or equal to value specified 0=All
...
x_left = 167           # Default=50 comment variable for auto calculate
x_right = 319         # Default=250 comment variable for auto calculate
y_upper = 80          # Default=90 comment variable for auto calculate
y_lower = 130         # Default=150 comment variable for auto calculate
